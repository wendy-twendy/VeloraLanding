    ...
    <>
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="mb-10">
            <Link href="/">
              <Button variant="ghost" className="text-light hover:text-accent-yellow group mb-6 px-0">
            ...
            <motion.h1 
              className="text-4xl sm:text-5xl font-bold font-display mb-6 bg-gradient-to-r from-accent-yellow to-primary-cyan text-gradient"
